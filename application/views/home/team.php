		...
		<div class="container">
			...
			<div class="wthree_team_grids">
				<div class="col-md-3 wthree_team_grid">
					<img src="<?php echo base_url();?>vendor/images/8.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="<?php echo base_url();?>vendor/images/9.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="<?php echo base_url();?>vendor/images/10.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="<?php echo base_url();?>vendor/images/11.png" alt=" " class="img-responsive" />
